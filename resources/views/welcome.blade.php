    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="sm:fixed sm:top-0 sm:left- p-6 text-left z-10">
                ...
                <a href=" {{ route('modelo') }} " class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"> Modelo </a>
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                    ...
                    <div id="informacion" class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <a href=" {{ route('validation.mostrarSinRegistro') }}" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Validación</h2>

                                <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                    Basado en la documentación del modelo de aceptacion 
                                    tecnologica (TAM), formulamos una encuesta de ambito calificativo, que nos brindara una calificacion de los usuarios frente a
                                     la solucion tecnologica propuesta.                                </p>
                            </div>
                ...
                <div id="contribuidores" class="w-full rounded-md dark:bg-gray-800/40 dark:bg-gradient-to-tl from-gray-700/50">
