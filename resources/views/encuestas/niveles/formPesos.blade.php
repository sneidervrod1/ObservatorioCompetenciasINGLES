            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('encuesta.actualizar', $nivel->id) }}" method="post">
                        ...
                        @endif
                        <div class="mt-4">
                            <input class="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded" type="submit" value="ACTUALIZAR">
                        </div>
                    </form>
                </div>
