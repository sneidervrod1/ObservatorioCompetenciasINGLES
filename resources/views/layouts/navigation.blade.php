        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('validation.crud')
                    <x-nav-link :href="route('validation.lista')" :active="request()->routeIs('validation.lista')">
                        Validación
                    </x-nav-link>
                    @endcan
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-dropdown-link :href="route('encuesta.listaSub')">
                                    Subcategoria
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('statements.index')">
                                    Pregunta
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
